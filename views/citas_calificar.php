...
<head>
    ...
    <title>Calificar experiencia</title>
</head>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <p class="lead"><b>Es completamente anonimo</b>, nos ayudara a ofrecerle un mejor servicio</p>
                <hr />
            </div>
        </div>
        ...
        <div class="row">
            <?php
        $citas = json_decode(file_get_contents("http://localhost:8080/DWF/v1/paciente/citas/tomadas/$idPaciente"), true);
            ...
            <div class="col">
                <div class="card carta" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="observaciones.php?idDoctor=<?php echo $doctor["doctorId"]?>&idCita=<?php echo $citas[$i]["citasId"]?>"
                            class="btn btn-success">Realizar observaciones</a>
                    </div>
                </div>
            </div>
            <?php
