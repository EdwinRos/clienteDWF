    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col">
                ...
                <p class="lead">Estimado <?php echo $_SESSION['nombrePaciente']?>, se le detallaran a continuacion su expediente de citas.</p>
            </div>
        </div>
        <div class="row">
            <?php
            ...
            ?>
                ...
                for ($i = 0; $i < count($expediente); $i++) {
                    ...
                    $registro = $expediente[$i]["registros"];
            ...
            <div class="solu_description">
              ...
              <div>
                    ...
                    <?php
                        echo substr($fecharegistro, 0, 10);
                    ?>
